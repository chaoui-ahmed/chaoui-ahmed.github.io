  ...
  const difficulties = [
    {
      id: "greedy",
      name: "GREEDY AI",
      description: "Maximizes immediate captures with corner strategy",
      power: 25,
    ...
    },
    {
      id: "minimax-3",
      name: "MINIMAX",
      description: "Strategic lookahead with alpha-beta pruning",
      power: 60,
    ...
    },
    {
      id: "monte-carlo",
      name: "MONTE CARLO",
      description: "Advanced simulation-based analysis",
      power: 80,
    ...
    },
    {
      id: "hybrid",
      name: "HYBRID MASTER",
      description: "Adaptive strategy: Minimax + Monte Carlo",
      power: 95,
