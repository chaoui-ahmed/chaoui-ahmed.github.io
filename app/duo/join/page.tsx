  ...
  return (
    <div className="min-h-screen bg-[#444444] flex items-center justify-center p-8">
      <div className="text-center">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-[#e2af00] mb-4">Rejoindre un Serveur</h2>
          <p className="text-white">Entrez l'adresse IP du serveur</p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  className="bg-[#444444] border-[#e2af00] text-white text-center text-lg"
                />
              </div>
